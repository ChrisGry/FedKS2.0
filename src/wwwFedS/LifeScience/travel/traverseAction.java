...
public class traverseAction {
	...
	public ArrayList<HashMap<String, HashMap<Integer, ArrayList<String>>>> plusArray = new ArrayList<>();// this is what
																											// we want
																											// to
	// plus
	...
	public void start(ParsingUnit pUnit, InitialHelper iHelper) throws Exception {
		...
		for (int index = 0; index < possibleQuery; index++) {
			...
			HashMap<String, HashMap<Integer, ArrayList<String>>> onePlus = generatePlus(StartPoint.get(index), pUnit,
					iHelper);
	...
	private HashMap<String, HashMap<Integer, ArrayList<String>>> generatePlus(ArrayList<Integer> kw, ParsingUnit pUnit,
			InitialHelper iHelper) throws Exception {
		HashMap<Integer, ArrayList<String>> unionMode = new HashMap<>();
		HashMap<Integer, ArrayList<String>> filterMode = new HashMap<>();
		String plus = "";
		for (int i = 0; i < kw.size(); i++) {
			unionMode.put(i, new ArrayList<String>());
		...
		for (int i = 0; i < kw.size(); i++) {
			...
			plus += onePlus;
			filterMode.put(i, new ArrayList<String>());
			filterMode.get(i).add(plus);
		}
		// System.out.println("unionMode:\n"+unionMode);
		// System.out.println("filterMode:\n"+filterMode);
		System.out.println("filterMode:finished.");

		HashMap<String, HashMap<Integer, ArrayList<String>>> onePlus = new HashMap<>();
